<template>
  <div class="notification">
    <section class="xd-section xd-light">
      <section>
        <p v-show="showQuestion">
          Where has this Google Streetview picture been taken?
        </p>
        <p v-show="showHumanAnswer">
          Your guess is: {{ roundStore.humanCity }}.
        </p>
        <p v-show="showThinking">Let me think for a second...</p>
        <p v-show="showAiAnswer">
          I think this picture was taken in {{ roundStore.aiCity }}.
        </p>
        <p v-show="roundStore.explanationId">
          In particular, the colored areas below have helped me form my guess:
        </p>
