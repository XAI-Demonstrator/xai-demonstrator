<template>
  <div id="app" class="xd-app">
    <Header title="XAI Streetview" v-bind:standalone="standalone"/>
    <main>
      ...
      <section style="display: none; align-content: flex-end;    flex-wrap: wrap;    align-items: baseline;" class="xd-section xd-light" id = "legend">
          <ul class="legend">
            <li><span class="positiv"></span> {{prediction}}</li>
            <li><span class="negativ"></span> {{other}}</li>
        </ul>
       </section> 
      <section class="xd-section xd-light" id="radio" style="display: flex;    align-content: flex-end;    flex-wrap: wrap;    align-items: baseline;" >
        ...
          <label for="Berlin">Berlin</label>
          <button type="button" class="xd-button xd-secondary" style="width:auto; margin-left: auto;" v-on:click="answer()">Was I right?</button> 
      </section>
       <button style="display: none;" type="button" class="xd-button xd-secondary" id = "explain"  v-on:click="explain()">Explain it to me</button>
       <button style="display: none;" type="button" class="xd-button xd-secondary" id = "new"  v-on:click="restart()">Start again</button>
       <button type="button" class="xd-button xd-secondary" id = "submit" v-on:click="submitFile()">What the AI says</button> 
    </main>
