...
<i18n>
{
  "de": {
    ...
    "info1paragraph3": "Die automatisch erzeugten Erklärungen helfen dir, zu verstehen, welche Konzepte die KI für ihre Entscheidung verwendet und warum sie manchmal falsche Schlüsse zieht.",
    ...
    "info2paragraph2": "Die Erklärungen werden mit der XAI-Methode <em><abbr>TCAV</abbr></em> (<strong>T</strong>esting with <strong>C</strong>oncept <strong>A</strong>ctivation <strong>V</strong>ectors) generiert. Die Erklärung beschreibt in Worten, welche menschlich lesbaren Konzepte die Vorhersage am stärksten unterstützen oder ihr widersprechen.",
    ...
    "info2paragraph4": "<small>Erklärungen: <a href='https://github.com/petrvach/TCAV'>TCAV</a><br />",
  ...
  "en": {
    ...
    "info1paragraph3": "The automatically generated explanations help you understand which concepts the AI uses for its decision and why it sometimes fails to do so.",
    ...
    "info2paragraph2": "The explanations are generated by the XAI method <em><abbr>TCAV</abbr></em> (<strong>T</strong>esting with <strong>C</strong>oncept <strong>A</strong>ctivation <strong>V</strong>ectors). The explanation describes in words which human-readable concepts most strongly support or oppose the prediction.",
    "info2paragraph3": "<small>Model: neural network based on <a href='https://www.tensorflow.org/api_docs/python/tf/keras/applications/mobilenet_v2'>MobileNetV2 for Keras</a>",
    "info2paragraph4": "<small>Explanations: <a href='https://github.com/petrvach/TCAV'>TCAV</a><br />",
...
.explanation-text__label {
  font-weight: 700;
  margin-bottom: 4px;
}

.explanation-text__content {
  margin: 0;
}
